...
const Perfil: React.FC = () => {
  ...
  const handledPerfil = useCallback(
    async (data: PerfilFormatData) => {
      try {
        ...
        const schema = Yup.object().shape({
          ...
          password: Yup.string().when('old_password', {
            is: (val) => !!val.length,
            then: Yup.string().min(6, 'No mínimo de 6 dígitos!'),
